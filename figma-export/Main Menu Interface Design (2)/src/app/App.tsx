        ...
        <header className="flex items-center gap-3 px-5 py-3.5 border-b border-border bg-card shrink-0">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-2 px-3.5 py-2 rounded-xl border border-[#4f46e5]/30 bg-[#eef2ff] hover:bg-[#e0e7ff] text-[#4f46e5] transition-colors cursor-pointer text-sm font-medium"
            >
              Sign In
            </button>
...
function SidebarContent({ activeSection, onNavigate, onClose, onRandomQuiz, onSignIn }: SidebarContentProps) {
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="px-3 py-4 border-t border-border shrink-0 flex flex-col gap-2">
        ...
        <button
          onClick={onSignIn}
          className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-gradient-to-r from-[#4f46e5] to-[#7c3aed] text-white hover:opacity-90 transition-opacity cursor-pointer text-sm font-medium shadow-sm shadow-[#4f46e5]/20"
        >
          Sign In / Register
        </button>

        {/* User card (guest placeholder) */}
        <button
