...
import { Plus, Trash2, GripVertical, CheckCircle2, Circle, Save, Eye, Edit3, Tag, HelpCircle, AlignLeft } from "lucide-react";
...
interface CustomQuizProps {
  onSave: (quiz: CustomQuizData) => void;
}

export function CustomQuiz({ onSave }: CustomQuizProps) {
  ...
  const handleSave = () => {
    onSave({ title, description, subject, questions });
    setSaved(true);
