...
// AUTH-005, gate widened by AUTH-007 (docs/decisions/0041, reopening 0025
// Decision 1): same two-layer gate as the editor page (LessonContentPage) —
// the can_edit_course(courseId) check below is the UI-level gate; the actual
// security boundary underneath it is RLS — "lesson_versions: editor read"
// (migration 041 §8) restricts every lesson_versions row, published or not,
// to can_edit_course editors. A non-editor hitting this route directly would
// get `notFound()` below regardless (getLessonVersionDocument returns null),
// even with the gate above somehow bypassed.
//
