...
const TABS: { tab: ProgressTab; href: string; label: string }[] = [
  { tab: "stats", href: "/app/progress?tab=stats", label: "Stats" },
  { tab: "achievements", href: "/app/progress?tab=achievements", label: "Achievements" },
  ...
  { tab: "history", href: "/app/progress?tab=history", label: "History" },
];
