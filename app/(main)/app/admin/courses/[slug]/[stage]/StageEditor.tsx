...
export function StageEditor({
  ...
  function openPreview() {
    ...
    window.open(`/app/admin/courses/${course.slug}/${stage.key}/preview`, "_blank");
  }
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-3">
        <Link
          href={`/app/admin/courses/${course.slug}`}
          className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors"
          onClick={(e) => handleLeaveClick(e, `/app/admin/courses/${course.slug}`)}
        >
      ...
      <div className="flex items-center justify-between gap-3 pt-6 border-t border-border">
        {prev ? (
          <Link
            href={`/app/admin/courses/${course.slug}/${prev.key}`}
            className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors"
            onClick={(e) =>
              handleLeaveClick(e, `/app/admin/courses/${course.slug}/${prev.key}`)
            }
          >
        ...
        {next ? (
          <Link
            href={`/app/admin/courses/${course.slug}/${next.key}`}
            className="inline-flex items-center gap-1.5 text-sm text-muted-foreground hover:text-foreground transition-colors"
            onClick={(e) =>
              handleLeaveClick(e, `/app/admin/courses/${course.slug}/${next.key}`)
            }
          >
